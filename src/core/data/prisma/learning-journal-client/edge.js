...
config.injectableEdgeEnv = () => ({
  parsed: {
    LEARNING_JOURNAL_DATABASE_URL: typeof globalThis !== 'undefined' && globalThis['LEARNING_JOURNAL_DATABASE_URL'] || typeof process !== 'undefined' && process.env && process.env.LEARNING_JOURNAL_DATABASE_URL || undefined
  }
})
